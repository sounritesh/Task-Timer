...
/**
 * This object is used to define the constant used to access the data of the Timings table
 * It also contains some functions like getId and buildUriFromId
 */
